...
export class ForwardPlusRenderer extends renderer.Renderer {
    ...
    constructor(stage: Stage)     {
        ...
        entries: [
            ...
            { binding: 1, visibility: GPUShaderStage.FRAGMENT, buffer: { type: "read-only-storage" } }, // light set
            { binding: 2, visibility: GPUShaderStage.FRAGMENT, buffer: { type: "storage" } }, // cluster lights
        ...
        entries: [
            ...
            { binding: 2, resource: { buffer: this.lights.clusterBoundsBuffer } },
    ...
    override draw() {
        ...
        // - run the main rendering pass, using the computed clusters for efficient lighting
         ...
         const encoder = renderer.device.createCommandEncoder();
          ...
          this.lights.doLightClustering(encoder); // compute shader 
